...
public class SupplierLoaderTest {
    ...
    public void testExportDBtoXML() throws Exception {
        ...
        testLoader.exportSupplierData("./src/test/resources/data/testdata/testExportSupplier.xml", suppHandler);


        suppsLoaded.clear();
        assertEquals("Reset list of suppliers", 0, suppsLoaded.size());

        suppHandler = testLoader.loadSuppliersData("./src/test/resources/data/testdata/testExportSupplier.xml");
        suppsLoaded = suppHandler.getSuppliers();
