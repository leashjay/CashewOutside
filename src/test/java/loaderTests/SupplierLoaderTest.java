...
public class SupplierLoaderTest {
    ...
    public void testLoadSupplierFile() throws JAXBException {
        String fName = "./src/main/resources/data/Suppliers.xml";
        int numExpected = 4;
    ...
    public void testExportDBtoXML() throws Exception {
        ...
        testLoader.exportSupplierData("./src/main/resources/data/testdata/testExportSupplier.xml", suppHandler);


        suppsLoaded.clear();
        assertEquals("Reset list of suppliers", 0, suppsLoaded.size());

        suppHandler = testLoader.loadSuppliersData("./src/main/resources/data/testdata/testExportSupplier.xml");
        suppsLoaded = suppHandler.getSuppliers();
